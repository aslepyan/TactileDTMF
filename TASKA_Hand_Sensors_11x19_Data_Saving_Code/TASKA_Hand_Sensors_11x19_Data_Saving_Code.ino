/*******************************************************
   ...
   NOTE:  Proof-of-concept program. In the interest of simplicity
          ...
          processes such as the tick i
          nterrupt, run at higher
...
//const float TARGET_FREQUENCIES[] = {70.4e3, 113.0e3, 16.4e3, 21.7e3, 25.0e3, 32.3e3, 37.6e3, 40.3e3, 45.9e3, 51.0e3, 54.3e3, 61.0e3, 64.1e3, 75.8e3, 78.1e3, 87.7e3, 90.9e3, 97.1e3, 100.0e3, 109.0e3, 118.0e3, 122.0e3, 128.0e3, 164.0e3, 139.0e3, 145.0e3, 152.0e3, 156.0e3, 167.0e3, 176.0e3, 187.0e3};
//const int num_freqs = 31;

// Frequencies for the TASKA Hand Cut-out sensors
const float SAMPLING_FREQUENCY = 2702556.62;
const float TARGET_FREQUENCIES[] = {132e3, 128e3, 125e3, 122e3, 114e3, 110e3, 104e3, 100e3, 94.3e3, 89.3e3, 84.7e3, 82e3, 74.6e3, 72.5e3, 69.4e3, 64.1e3, 58.1e3, 53.8e3, 50.5e3, 139e3, 135e3, 132e3, 46.3e3, 43.1e3, 39.1e3, 33.8e3, 30.1e3, 25e3, 20.8e3, 16e3, 10.4e3, 6.25e3, 2.36e3};
const int num_freqs = 33;
